...
ratio = [1e-1 1 1e1 1e2]; 
seed = 1e4;
solution = []

for i=1:4
    [t, y] = main(seed, ratio(i))
    solution(1:length(y), 1:4, i) = y
    solution(1:length(t), 5, i) = t
end


function [t, y] = main(TargetSeed, CTLvsTarget)
tspan = [0 100];
y0 = [CTLvsTarget*TargetSeed; TargetSeed; 1e-10; 1e-7]; %initial conditions (cell seed amounts)
...
C_PAMS = 5000; %nM concentration of P-AMS from SET2 assay TG did
